...
class DataCreateCourier:
    ...
    # генерация фэйковых данных без поля "Login"
    @staticmethod
    ...
    # генерация фэйковых данных без поля "Password"
    @staticmethod
...
class Courier:
    ...
    # регистрация в системе с возвратом ответа и данных курьера
    @staticmethod
    ...
    # логин в системе с возвратом ответа и id курьера
    @staticmethod
